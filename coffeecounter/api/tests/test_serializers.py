...
class TestSerializers(TestCase):
    ...
    def test_statistic_serializer(self):
        coffeeuser_perry = CoffeeUser.objects.create(user=self.user_perry, twitter='@perry')
        coffeeuser_jacob = CoffeeUser.objects.create(user=self.user_jacob, twitter='@jacob')
        ...
        PoweredBadge.objects.create(user=self.user_perry, badge=badge1)
        PoweredBadge.objects.create(user=self.user_perry, badge=badge2)
        PoweredBadge.objects.create(user=self.user_perry, badge=badge3, power=2)
